...
const ModalPickDocs = ({ isModalOpen, setIsModalOpen, onFinish }: ItemProps) => {
  ...
  return (
    <>
      <Modal title="Thêm bộ tài liệu" visible={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
